...
# allowing import of the 'api_expert' module for reading __version__.

import os
import sys

# Add the current directory to sys.path to enable local module imports during build
# This resolves the ModuleNotFoundError for 'api_expert' in the isolated build environment
